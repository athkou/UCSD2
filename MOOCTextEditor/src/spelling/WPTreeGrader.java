...
public class WPTreeGrader {
    ...
    public static void main (String[] args) {
        ...
        PrintWriter out;
        try {
            out = new PrintWriter("C:/DEV/Workspace/UCSD2/MOOCTextEditor/grader_output/module5.part3.out");
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
        ...
        try {
            ...
            DictionaryLoader.loadDictionary(dict, "C:/DEV/Workspace/UCSD2/MOOCTextEditor/data/grader_dict.txt");
