...
public class BasicDocumentGrader {
    public static void main(String[] args) {
        try
        {
            ...
            BufferedReader br = new BufferedReader(new FileReader("C:\\DEV\\Workspace\\UCSD2\\MOOCTextEditor\\test_cases\\mod1TestCases.txt"));
            String line;
            PrintWriter out = new PrintWriter("C:\\DEV\\Workspace\\UCSD2\\MOOCTextEditor\\grader_output\\module1.part1.out", "utf-8");
